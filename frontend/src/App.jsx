  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/orders/:orderId/transport" element={
          <ProtectedRoute><ArrangeTransport /></ProtectedRoute>
        } />
        ...
        <Route path="/dashboard/truck-owner" element={
          <ProtectedRoute role="TRUCK_OWNER"><TruckOwnerDashboard /></ProtectedRoute>
        } />
